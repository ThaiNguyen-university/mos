...
<body>
    ...
    <div class="container" id="form_container">
        <form id="theForm" action="https://script.google.com/macros/s/AKfycbwhTnX8CTNxzxXTget1YY4GimAiY9vMsoGaL0wfTtQ7yGP7O0m09eTpwvxOQMM0hCpKfA/exec" method="GET" onsubmit="return preventRepeatedSubmission();">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/1.wav">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/2.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/3.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/4.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/5.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/6.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/7.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/8.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/9.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/10.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/11.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/12.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/13.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/14.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/15.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/16.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/17.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/18.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/19.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/20.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/21.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/22.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/23.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/24.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/25.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/26.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/27.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/28.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/29.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/30.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/31.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/32.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
        ...
        <div class="card form-group">
            ...
            <div class="card-body">
                <p>
                    <audio controls src="wavs/mmos/33.wav">
                        Your browser does not support the audio element.
                    </audio>
                </p>
                <div class="form-check">
